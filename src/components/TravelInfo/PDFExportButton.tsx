    ...
    <>
      <div className="flex flex-col items-end">
        <button
          ...
          className={`inline-flex items-center gap-2 px-4 py-2 bg-stone-800 text-white rounded-lg hover:bg-stone-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
          aria-label="PDFとして出力"
        >
          {isGenerating ? (
          ...
          <span className="text-sm font-bold">PDF出力</span>
        </button>
        {error && (
